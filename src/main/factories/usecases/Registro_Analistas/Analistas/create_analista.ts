...
export const makeDbCreateAnalista = ():CreateAnalista => {
    ...
    return new DbCreateAnalista(repositoryAnalista,repositoryAnalista,repositoryDireccion,repositoryDireccion,repositoryUnidad,repositoryUnidad,repositoryZona,repositoryZona)
}